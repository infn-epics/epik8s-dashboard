...
export default function LLRFWidget({ config, client }) {
  ...
  if (viewMode === 'detail') {
    return <LLRFDetail pvPrefix={pvPrefix} client={client} config={config} />;
  }
  return <LLRFEssential pvPrefix={pvPrefix} client={client} config={config} />;
}

/* ============================================================
   Essential view — compact LLRF overview
   ============================================================ */
function LLRFEssential({ pvPrefix, client, config }) {
    ...
    <div className="llrf-widget-body llrf-essential">
      ...
      <div className="llrf-section">
        <div className="llrf-field-row">
          <PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:vm:dsp:sp_amp:power` : ''} label="Amp SP" precision={precision} unit="μW" />
          <PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:vm:dsp:sp_ph:phase` : ''} label="Phase SP" precision={precision} unit="°" />
        </div>
      </div>
      ...
      <div className="llrf-section">
        ...
        <div className="llrf-field-row">
          <PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:${ch}:power_remote.POWER` : ''} label="Power" precision={precision} unit="W" />
          <PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:${ch}:amp_phase.PHASE_REMOTE` : ''} label="Phase" precision={precision} unit="°" />
        </div>
      </div>
    </div>
  );
...
/* ============================================================
   ...
   ============================================================ */
function LLRFDetail({ pvPrefix, client, config }) {
  ...
  return (
    <div className="llrf-widget-body llrf-detail">
      ...
      {tab === 'overview' && <OverviewTab pvPrefix={pvPrefix} client={client} precision={precision} />}
      {tab === 'channels' && <ChannelsTab pvPrefix={pvPrefix} client={client} precision={precision} />}
      {tab === 'feedback' && <FeedbackTab pvPrefix={pvPrefix} client={client} precision={precision} />}
      {tab === 'conditioning' && <ConditioningTab pvPrefix={pvPrefix} client={client} config={config} precision={precision} />}
    </div>
  );
}
...
function OverviewTab({ pvPrefix, client, precision }) {
  return (
...
function ChannelsTab({ pvPrefix, client, precision }) {
        ...
        <tbody>
          {channels.map(ch => (
            <tr key={ch}>
              ...
              <td><PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:${ch}:power_remote.POWER` : ''} precision={precision} /></td>
              <td><PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:${ch}:amp_phase.PHASE_REMOTE` : ''} precision={precision} /></td>
              <td><PvDisplay client={client} pvName={pvPrefix ? `${pvPrefix}:${ch}:amp_average_s.AVERAGE` : ''} precision={precision} /></td>
            </tr>
          ))}
        </tbody>
      </table>
...
function FeedbackTab({ pvPrefix, client, precision }) {
  return (
    <div className="llrf-tab-body">
...
function ConditioningTab({ pvPrefix, client, config, precision }) {
      ...
      {!condPv ? (
        ...
        <>
          ...
          <div className="llrf-field-row">
            ...
            <PvDisplay client={client} pvName={`${condPv}:CONDITIONING_TARGET`} label="Target" unit="kW" precision={precision} />
          </div>
          ...
          <div className="llrf-field-row">
            ...
            <PvDisplay client={client} pvName={`${condPv}:RAISE_COUNT`} label="Count" precision={0} />
          </div>
